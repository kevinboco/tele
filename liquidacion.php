...
/* =======================================================
   🔹 Formulario inicial (con CHECKBOXES en lugar de select)
======================================================= */
...
/* =======================================================
   🔹 Cálculo y armado de tablas DINÁMICO - VERSIÓN MULTIEMPRESA
======================================================= */
$desde = $_GET['desde'];
$hasta = $_GET['hasta'];
...
<body class="bg-slate-100 min-h-screen text-slate-800">
    ...
    <div class="bg-white border border-slate-200 rounded-2xl shadow-sm px-5 py-4">
      <div class="flex flex-col gap-3">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between w-full gap-3">
          <div class="flex items-center gap-3">
            ...
            <span class="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-purple-100 text-purple-700 text-sm font-medium">
              📊 <?= count($empresasSeleccionadas) ?> empresas seleccionadas
            </span>
          </div>
        ...
        <div class="flex flex-wrap items-center gap-2 mt-2">
          <span class="text-sm font-medium text-slate-600">Empresas:</span>
  ...
  <!-- Panel crear clasificación (sin cambios) -->
  ...
  <!-- Panel clasificación rutas (sin cambios) -->
  ...
  <!-- Panel selector columnas (sin cambios) -->
  ...
  <!-- Modal VIAJES (modificado para manejar empresa específica) -->
